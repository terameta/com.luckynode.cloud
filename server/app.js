...
var db = {};
    ...
    db.nodecs		= mongojs('cloud',['nodecs']).nodecs;
    db.nodetokens	= mongojs('cloud',['nodetokens']).nodetokens;
    db.managers		= mongojs('cloud',['managers']).managers;
    db.plans		= mongojs('cloud',['plans']).plans;
    db.servers		= mongojs('cloud',['servers']).servers;
    db.images		= mongojs('cloud',['images']).images;
    db.isofiles		= mongojs('cloud',['isofiles']).isofiles;
