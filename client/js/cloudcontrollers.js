...
cloudControllers.controller('imageController',['$scope', '$rootScope', '$state', '$stateParams', '$server', '$datacenter', '$plan', '$image', '$storage',
	function($scope, $rootScope, $state, $stateParams, $server, $datacenter, $plan, $image, $storage){
		...
		$scope.deleteImage = function(){
			if(confirm("Are you sure you want to delete " + $scope.curImage.name)){
				$scope.curImage.$delete(function(result, error){
